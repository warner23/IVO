...
WIScript.gridEdit = function(name, id){
    console.log("clicked");
    var clas = $(".editting");
    if(clas.hasClass("editting-"+id)){
        $(".attrsPanels").css("display","block");
        $(".editting").removeClass("editting-"+id);

    }else{
        $(".attrsPanels").css("display","none");
        $(".editting").addClass("editting-"+id)
    }
}
