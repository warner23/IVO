$(document).ready(function(event)
{
    ...
    $("#downloadModal").click(function(e) {
        e.preventDefault();
        $("#downloadingModal").removeClass('hide').removeClass('fade');
        $("#downloadingModal").addClass('show');
...
WIScript.changeStructure = function(){
...
WIScript.downloadLayoutSrc = function(){
    ...
    $("#downloaingdModal textarea").empty();
    $("#downloadingModal textarea").val(formatSrc);
    webpage = formatSrc;
}
