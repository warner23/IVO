...
( 'Blog');
    ...
    public function TransferFiles($configs, $plug)
    {
            ...
            $check1 = dirname(dirname(dirname(dirname(dirname(dirname(__FILE__)))))) . '/WIModule/blog';

            if(!file_exists($check1)){
              $this->System->custom_copy($source1 , $dest1);
            }
            ...
            if(!file_exists($check4)){
              $this->System->custom_copy($source4 , $dest4);
            }
